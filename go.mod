...
replace (
	...
	github.com/cosmos/iavl => github.com/cryptobadass/plume-iavl v0.1.9
	...
	// v1.0.1 corresponds to the original v0.0.46 version
	...
	github.com/tendermint/tendermint => github.com/cryptobadass/plume-tendermint v0.4.7
