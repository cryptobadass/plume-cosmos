...
// PubKey defines a PQC public key (Falcon-512)
type PubKey struct {
...
// PrivKey defines a PQC private key (Falcon-512)
type PrivKey struct {
	Key []byte `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
}
...
var fileDescriptor_5bababf27292193e = []byte{
	...
	0xd3, 0x93, 0xd8, 0xc0, 0xae, 0x31, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x84, 0x8c, 0xa8, 0x11,
	0xd6, 0x00, 0x00, 0x00,
}
